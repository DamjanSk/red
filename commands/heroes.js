...
var heroes = [{
  ...
  street_names: ['puppy queen', 'corina'],
  ...
  street_names: ['kirin', 'half-dragon'],
  ...
  street_names: ['thunder', 'thunder gigas', 'lightning elemental'],
  ...
  url: 'https://www.dropbox.com/s/8tzdafhkuha58bq/sukha.jpg?dl=0',
  street_names: [],
